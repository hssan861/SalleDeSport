...
import tn.esprit.SalleDeSport_Offer_Reservation.Entities.ReservationCountCallback;
import tn.esprit.SalleDeSport_Offer_Reservation.Services.ExcelService;
...
public class Affiche_Offer_FXMLController implements Initializable {
    ...
    @FXML
    private TableColumn<Offer, String> C_img;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        C_NBreservation.setCellValueFactory(new ReservationCountCallback());
        C_img.setCellValueFactory(new PropertyValueFactory<Offer, String>("img") );
