...
public class Ajouter_Offer_FXMLController implements Initializable {
    ...
    private void addAction(ActionEvent event) {
        ...
        if (tf_TitleOffer.getText().isEmpty()|| tfPrix.getText().isEmpty() ||
                 tf_DateDebuOffer.getValue().equals(0) || tf_DateFinOffer.getValue().equals(0) || tf_Description.getText().isEmpty()||FicheArtc.getText().isEmpty()){
            ...
            sp.ajouterOffer(new Offer( tf_TitleOffer.getText(),tf_Description.getText(), Float.parseFloat(tfPrix.getText()), DateDebut,DateFin,FicheArtc.getText()));
