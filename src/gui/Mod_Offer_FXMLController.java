...
public class Mod_Offer_FXMLController implements Initializable {
    ...
    //setters and getters
    @FXML
    private TextField tfNBmax_Mod;
    @FXML
    private Label err_nb_max_offer;
    ...
    public TextField getTfNBmax_Mod() {
        return tfNBmax_Mod;
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       //..
        ...
        err_nb_max_offer.setVisible(false);
        ...
        tfNBmax_Mod.setText(String.valueOf(offer.getNb_max_reservation()));
    ...
    private void addAction(ActionEvent event) {
          if (tf_TitleOffer_Mod.getText().isEmpty()|| tfPrix_Mod.getText().isEmpty() ||
                 tf_DateDebuOffer_Mod.getValue().equals(0) || tf_DateFinOffer_Mod.getValue().equals(0) || tf_Description_Mod.getText().isEmpty()||tfNBmax_Mod.getText().isEmpty()){
            ...
            err_nb_max_offer.setVisible(true);
        ...
        offer.setNb_max_reservation(Integer.parseInt(tfNBmax_Mod.getText()));
