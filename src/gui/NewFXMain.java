...
public class NewFXMain extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        /*Parent  root = FXMLLoader.load(getClass().getResource("Affiche_Offer_FXML.fxml"));
        Scene scene = new Scene(root, 1100, 600); // Adjust the width and height as needed
        primaryStage.setTitle("admin Offer");
        ...
        primaryStage.setTitle("admin Reservation");
        primaryStage.setScene(scene);
        primaryStage.show();*/
        
        /*Parent  root = FXMLLoader.load(getClass().getResource("/gui/Abonnement.fxml"));
        Scene scene = new Scene(root, 1100, 720); 
        primaryStage.setTitle("user Abonnement");
        primaryStage.setScene(scene);
        primaryStage.show();*/
    }
