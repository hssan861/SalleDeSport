...
public class GenerateQRCode {
    ...
    public static void generateQRcode(Event p, String path) throws WriterException, IOException {
        // create the data string to encode in the QR code
        String data = p.getIdEvent() + "\n"
                + p.getTitreEvent() + "\n"
                + "Price: " + p.getPrixEvent() + "\n"
                + "adresse: " + p.getAdresseEvent() + "\n"
                + "coach: " + p.getNomCoach() + "\n"
                + "image: " + p.getImgEvent() + "\n"
                + "type: " + p.getTypeEvent();
